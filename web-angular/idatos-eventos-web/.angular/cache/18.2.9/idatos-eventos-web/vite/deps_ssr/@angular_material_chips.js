...
var MatChip = class _MatChip {
  ...
  constructor(_changeDetectorRef, _elementRef, _ngZone, _focusMonitor, _document, animationMode, _globalRippleOptions) {
    ...
    this._onFocus = new import_rxjs3.Subject();
    this._onBlur = new import_rxjs3.Subject();
    this.role = null;
  ...
  ngAfterContentInit() {
    this._actionChanges = (0, import_rxjs3.merge)(this._allLeadingIcons.changes, this._allTrailingIcons.changes, this._allRemoveIcons.changes).subscribe(() => this._changeDetectorRef.markForCheck());
  }
  ngDoCheck() {
...
var MatChipRow = class _MatChipRow extends MatChip {
  constructor(changeDetectorRef, elementRef, ngZone, focusMonitor, _document, animationMode, globalRippleOptions, tabIndex) {
    ...
    this.role = "row";
    this._onBlur.pipe((0, import_operators3.takeUntil)(this.destroyed)).subscribe(() => {
...
var MatChipSet = class _MatChipSet {
  ...
  _getChipStream(mappingFunction) {
    return this._chips.changes.pipe((0, import_operators3.startWith)(null), (0, import_operators3.switchMap)(() => (0, import_rxjs3.merge)(...this._chips.map(mappingFunction))));
  }
  ...
  _setUpFocusManagement() {
    this._chips.changes.pipe((0, import_operators3.startWith)(this._chips)).subscribe((chips) => {
      const actions = [];
    ...
    this.chipFocusChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(({
      chip
    }) => {
    ...
    this._dir?.change.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe((direction) => this._keyManager.withHorizontalOrientation(direction));
  }
  /**
  ...
  _trackChipSetChanges() {
    this._chips.changes.pipe((0, import_operators3.startWith)(null), (0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => {
      if (this.disabled) {
  ...
  _trackDestroyedFocusedChip() {
    this.chipDestroyedChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe((event) => {
...
var MatChipListbox = class _MatChipListbox extends MatChipSet {
  ...
  ngAfterContentInit() {
    ...
    this.chipBlurChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this._blur());
    this.chipSelectionChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe((event) => {
      if (!this.multiple) {
        this._chips.forEach((chip) => {
...
var MatChipGrid = class _MatChipGrid extends MatChipSet {
  ...
  ngAfterContentInit() {
    this.chipBlurChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => {
      this._blur();
      this.stateChanges.next();
    });
    (0, import_rxjs3.merge)(this.chipFocusChanges, this._chips.changes).pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this.stateChanges.next());
  }
  ngAfterViewInit() {
